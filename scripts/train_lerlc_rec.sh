...
# RL4RS environment
mkdir -p output/KuaiRec/
mkdir -p output/KuaiRec/agents/

output_path="output/KuaiRec/"
...
# policy args
POLICY_CLASS='OneStagePolicy_LERLC'
HA_VAR=0.1
HA_CLIP=1.0
COEF=0.01
...
# critic args
CRITIC_CLASS='LERLCCritic'


# buffer args
BUFFER_CLASS='LERLCBuffer'
BUFFER_SIZE=2000
