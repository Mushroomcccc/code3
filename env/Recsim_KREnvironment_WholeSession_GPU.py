...
class Recsim_KREnvironment_WholeSession_GPU(BaseRLEnvironment):
    ...
    def __init__(self, args):
        ...
        # Recsim
        self.item_kale = torch.load('/content/gdrive/MyDrive/KRLBenchmark-main/code/recsim/item_kale').to(args.device)[
                         :, :-1]
        self.user_kale = torch.load('/content/gdrive/MyDrive/KRLBenchmark-main/code/recsim/user_kale').to(args.device)[
                         :, :, :-1]
