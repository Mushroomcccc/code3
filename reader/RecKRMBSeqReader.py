...
class RecKRMBSeqReader(BaseReader):
    ...
    def __init__(self, args):
        ...
        self.item_types = pd.read_csv(path + 'item_types.csv').to_numpy().reshape(-1)
        super().__init__(args)
    ...
    def _read_data(self, args):
        ...
        self.selected_item_features = ['video_type', 'video_tag_name', 'visible_status', 'upload_type',]
    ...
    def _sequence_holdout(self, args):
        ...
        for u in tqdm(self.users):
            ...
            if n_train < 0.6 * len(sub_df):# or n_train < 10:
                continue
