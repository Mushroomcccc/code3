...
class DqnBuffer(BaseBuffer):
    ...
    def reset(self, *reset_args):
        ...
        self.buffer['policy_output']['action'] = torch.zeros(self.buffer_size, actor.effect_action_dim) \
    ...
    def sample(self, batch_size):
        ...
        policy_output = {"state": self.buffer["policy_output"]["state"][indices],
                         "action": self.buffer["policy_output"]["action"][indices]}  # main change to BaseBuffer
        # user response
