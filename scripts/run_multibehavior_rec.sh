...
# output path
mkdir -p output
mkdir -p output/KuaiRec${KR_FLAG}/
mkdir -p output/KuaiRec${KR_FLAG}/env
mkdir -p output/KuaiRec${KR_FLAG}/env/log

output_path=output/KuaiRec${KR_FLAG}/

# data source path
data_path=dataset/KuaiRec${KR_FLAG}/
    ...
    do
        ...
        do
            ...
            python train_multibehavior.py\
                ...
                --train_file ${data_path}big_matrix_click.csv\
                --user_meta_file ${data_path}user_features.csv\
                --item_meta_file ${data_path}item_features.csv\
