...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--trans_cat', type=int, default=0, help='')
    ...
    parser.add_argument('--window_size', type=int, default=4, required=False, help='quit mechanism')
    ...
    args.trans_cat = initial_args.trans_cat
